...
export async function registerUser(apiBase: string, username: string, email: string, password: string, confirmPassword: string) {
  const base = apiBase || ""
  const payload = {
    username,
    email,
          ...
          <form
            ...
            onSubmit={async (e) => {
              ...
              try {
                ...
                const data = await registerUser(API_BASE, name, email, password, confirmPassword)
